...
int main()
{
    ...
    Shader equirectangularToCubemapShader("ibl_specular_textured/2.2.2.cubemap.vs", "ibl_specular_textured/2.2.2.equirectangular_to_cubemap.fs");
    Shader irradianceShader("ibl_specular_textured/2.2.2.cubemap.vs", "ibl_specular_textured/2.2.2.irradiance_convolution.fs");
