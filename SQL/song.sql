...
-- SELECT * FROM song LEFT JOIN songtab ON song.title = songtab.title; -- list all stuff in song, if no match:null display

SELECT * FROM song RIGHT JOIN songtab ON song.title = songtab.title; -- list all stuff in song, if no match:null display
