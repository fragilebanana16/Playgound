...
import { useIntersectionObserver } from '@/hooks/music/useIntersectionObserver'
...
<template>
  <div class="px-2 pt-4">
    ...
    <div class="py-2">
      <div class="grid lg:grid-cols-[repeat(auto-fill,minmax(180px,1fr))] grid-cols-[repeat(auto-fill,minmax(100px,1fr))] gap-2">
        <div
